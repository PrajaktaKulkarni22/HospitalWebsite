...
function RoomCategories(){
    ...
    return(
        <div>
            <div class="navbar1" style={{marginTop:'-105px'}}>
...
<div id="luxury">Luxury room<br/><h4 style={{lineHeight:"-10"}}>Single centrally air conditioned well furnished accommodation with <br/>attached bathroom, sofa-cum-bed for attendant, <br/>TV and telephone facilities.</h4><img src="https://www.jehangirhospital.com/images/room-categories/luxury-room.jpg" width="500px" height="500px"/><hr ></hr></div>
<div id="super-delux">Super Delux<br/><h4>Single centrally air conditioned, well-furnished accommodation with attached bathroom, sofa-cum-bed for attendant, central oxygen suction facility, TV, telephone and mini fridge.</h4><img src="https://www.jehangirhospital.com/images/room-categories/super-deluxe.jpg" width="500px" height="500px"/><hr></hr></div>
<div id="general-ward">General Ward<br/><h4>A dormitory style layout beds. <br/>Each bed has a bed side trolley and common bathroom. <br/>There are separate wards for men and women.</h4><img src="https://www.jehangirhospital.com/images/room-categories/general-ward.jpg"width="500px" height="500px"/><hr></hr></div>
<div id="day-care">Day Care<br/><h4>We have state of the art Day Care facility with nature friendly ambience and attendant sit outs. Treatment is provided on adjustable cozy chairs to make the whole experience feel pain-free.</h4><img src="https://www.jehangirhospital.com/images/room-categories/day-care.jpg" width="500px" height="500px"/><hr></hr></div>
<div id="emergency">Emergency Room<br/><h4>Cubicles with all essential and advanced life-support equipment necessary for critical care and close monitoring of patients..</h4><img src="https://downloads.healthcatalyst.com/wp-content/uploads/2019/08/Emergency-Department-Throughput.jpg" width="500px" height="500px"/><hr></hr></div>
<div id="icu">ICU Room<br/><h4>This section of the hospital has cubicles to provide sick patients with the highest level of treatments.</h4><img src="https://www.jehangirhospital.com/images/room-categories/icu-room.jpg" width="500px" height="500px"/><hr></hr></div>

</div>

            </div>

            <footer class="footer-section" style={{marginTop:'1550px'}}>
