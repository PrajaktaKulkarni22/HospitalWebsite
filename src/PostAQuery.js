    ...
    return(
        ...
        <div class="backhome"></div>
            <div className="backhome-text">
                <h3 id="aboutus" style={{marginTop:'20px'}}>Post Your Query</h3>
                <Link to="/" id="homelink"><h3>Home  <span id="greaterthan"> {'>'} </span></h3> </Link>
                <h3 id="abouttext">Post Your Query</h3>
            </div>
       ...
       <form action="" id="log-in-doctor" style={{marginTop:'-50px'}}>
       <div id="namediv">
              <label id="qid"></label>
           ...
           <div id="pdiv" style={{marginTop:'-40px'}}>
               <label id="pid">Phone number</label>
               <input type="text" id="ptext" name="phonenumber" placeholder="Enter your phone number here"  />
           </div>
           <div id="querydiv" >
           ...
           <input type="submit" id="dsubmit" name="postaquery" value="Post Your Query" style={{marginTop:'30px'}}/>
